...
//    }
    ...
    public String getDescription() {
        ...
        sb.append("Contract ID: ").append(contract_id).append("\n");
        sb.append("Supplier ID: ").append(supplier_id).append("\n");
        sb.append("Days to Ready: ").append(days_toReady).append("\n");
        
        sb.append("Items List:").append("\n");
        if (item_list.isEmpty()) {
            sb.append("No items available").append("\n");
        } else {
            for (Map.Entry<Product, Integer> entry : item_list.entrySet()) {
                Product product = entry.getKey();
                int quantity = entry.getValue();
                sb.append(product.toString()).append(" -->  Quantity: ").append(quantity).append("\n");
                sb.append("-----------------------------").append("\n");
            }
        }
        
        sb.append("Supplier Configuration: ");
        if (supplier_config.getKey()) {
            sb.append("Can fixed days");
        } else {
            sb.append("Cannot fixed days");
        }
        
        sb.append(", ");
        
        if (supplier_config.getValue()) {
            sb.append("Responsible for delivery");
        } else {
            sb.append("Not responsible for delivery");
        }
